---
name: reels-scripter
description: 'Turn any topic into a professional, beat-by-beat Instagram Reels script that imitates the exact style of the reference reels in referens-reels-hook/ — a 15-reel corpus of Mikhail Timochko''s Russian business/self-growth reels, torn down frame-by-frame and word-for-word. Scripts are written in RUSSIAN by default (the reference language), with an optional Uzbek adaptation pass at the end. The skill obeys a measured style profile: sentence length, hook formulas, two-register on-screen text, speech-locked cut cadence, progressive text build, one-imperative rule, and the comment-keyword CTA formula. Output is a shot-list a video engine (Higgsfield) can produce directly. Use this skill whenever the user wants a reel, a short video, a Reels/TikTok/Shorts script, "reels yozib ber", "reels ssenariy", "video skript", "ssenariy yoz", says they added reference videos, or hands over a content-plan item whose format is reels/video — even if they don''t say the word "reel". Chains after viral-hooks and hands off to higgsfield-content-factory / video-producer (the video) and caption-cta-writer (the caption).'
---
